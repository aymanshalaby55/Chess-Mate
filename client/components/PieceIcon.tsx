...
const PieceIcon: React.FC<PieceIconProps> = ({ piece, className = '', size = 16 }) => {
  ...
  switch (type) {
    case 'p': // Pawn
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 45 45">
          <path
    ...
    case 'r': // Rook
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 45 45">
          <g fill={fillColor} stroke={darkColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 45 45">
          <g fill={fillColor} stroke={darkColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z" fill={darkColor} stroke={darkColor} />
            <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill={darkColor} stroke={darkColor} />
          </g>
        </svg>
      );
    case 'b': // Bishop
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 45 45">
          <g fill={fillColor} stroke={darkColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <g fill="none" stroke={darkColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2z" />
              <path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z" />
              <path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z" />
            </g>
            <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" stroke={lightColor} strokeWidth="1" strokeLinejoin="miter" />
          </g>
        </svg>
      );
    case 'q': // Queen
      ...
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 45 45">
          <g fill={fillColor} stroke={darkColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z" strokeLinecap="butt" />
